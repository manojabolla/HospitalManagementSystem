...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/frs","root","MANISHA");PreparedStatement ps2=con.prepareStatement("insert into staff values(?,?,?,?,?,?)");
